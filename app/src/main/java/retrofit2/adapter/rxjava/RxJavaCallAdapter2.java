...
final class RxJavaCallAdapter2<R> implements CallAdapter<R, Object> {
  ...
  private final @Nullable Scheduler schedulerObserverOn;
  ...
  RxJavaCallAdapter2(Type responseType, @Nullable Scheduler schedulerSubscribeOn, @Nullable Scheduler schedulerObserverOn, boolean isAsync,
